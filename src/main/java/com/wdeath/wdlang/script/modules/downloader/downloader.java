package com.wdeath.wdlang.script.modules.downloader;
...
public final class downloader implements Module {
    ...
    public void init(ScriptProgram scriptProgram) {
        scriptProgram.getFunctions().set("getContentLength", this::getContentLength);
        scriptProgram.getFunctions().set("downloader", this::downloader);
    }
