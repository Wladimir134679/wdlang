...
import com.wdeath.wdlang.script.lib.UserDefinedFunction;
...
public abstract class OptimizationVisitor<T> implements ResultVisitor<Node, T> {
    ...
    public ScriptProgram scriptProgram;

    protected OptimizationVisitor(ScriptProgram scriptProgram) {
    ...
    public Node visit(AssignmentExpression s, T t) {
        ...
        if ( (exprNode != s.expression || targetNode != s.target) && (targetNode instanceof Accessible) ) {
            return new AssignmentExpression(scriptProgram, s.operation, (Accessible) targetNode, (Expression) exprNode);
        }
        return s;
    }
    ...
    public Node visit(BinaryExpression s, T t) {
        ...
        if (expr1 != s.expr1 || expr2 != s.expr2) {
            return new BinaryExpression(scriptProgram, s.operation, (Expression) expr1, (Expression) expr2);
        }
        return s;
    }
    ...
    public Node visit(ContainerAccessExpression s, T t) {
        ...
        if (changed) {
            return new ContainerAccessExpression(scriptProgram, (Expression) root, indices);
        }
        return s;
    }
    ...
    public Node visit(DestructuringAssignmentStatement s, T t) {
        ...
        if (expr != s.containerExpression) {
            return new DestructuringAssignmentStatement(scriptProgram, s.variables, (Expression) expr);
        }
        return s;
    }
    ...
    public Node visit(ForeachArrayStatement s, T t) {
        ...
        if (container != s.container || body != s.body) {
            return new ForeachArrayStatement(scriptProgram, s.variable, (Expression) container, consumeStatement(body));
        }
        return s;
    }
    ...
    public Node visit(ForeachMapStatement s, T t) {
        ...
        final Node body = s.body.accept(this, t);
        if (container != s.container || body != s.body) {
            return new ForeachMapStatement(scriptProgram, s.key, s.value, (Expression) container, consumeStatement(body));
        }
        return s;
    }
    ...
    public Node visit(FunctionDefineStatement s, T t) {
        ...
        if (changed || body != s.body) {
            return new FunctionDefineStatement(scriptProgram, s.name, newArgs, consumeStatement(body));
        }
        return s;
    }
    ...
    public Node visit(FunctionalExpression s, T t) {
        ...
        final FunctionalExpression result = new FunctionalExpression(scriptProgram, (Expression) functionExpr);
    ...
    public Node visit(IncludeStatement s, T t) {
        ...
        if (expression != s.expression) {
            return new IncludeStatement(scriptProgram, (Expression) expression);
        }
        return s;
    }
    ...
    public Node visit(MatchExpression s, T t) {
        ...
        for (MatchExpression.Pattern pattern : s.patterns) {
            if (pattern instanceof MatchExpression.VariablePattern) {
                ...
                final VariableExpression expr = new VariableExpression(scriptProgram, variable);
        ...
        if (changed) {
            return new MatchExpression(scriptProgram, (Expression) expression, patterns);
        }
        return s;
    }
    ...
    public Node visit(ObjectCreationExpression s, T t) {
        ...
        if (changed) {
            return new ObjectCreationExpression(scriptProgram, s.className, args);
        }
        return s;
    }
    ...
    public Node visit(UseStatement s, T t) {
        final Node expression = s.expression.accept(this, t);
        if (expression != s.expression) {
            return new UseStatement(scriptProgram, (Expression) expression);
        }
        return s;
    }
    ...
    public UserDefinedFunction visit(UserDefinedFunction s, T t) {
        ...
        final Node body = s.body.accept(this, t);
        if (changed || body != s.body) {
            return new UserDefinedFunction(scriptProgram, newArgs, consumeStatement(body));
        }
        return s;
    }
