...
import com.wdeath.wdlang.script.exceptions.OperationIsNotSupportedException;
...
public final class BinaryExpression implements Expression {
    ...
    public BinaryExpression(ScriptProgram scriptProgram, Operator operation, Expression expr1, Expression expr2) {
    ...
    public Value eval() {
        ...
        try {
            ...
            if (scriptProgram.getFunctions().isExists(operation.toString())) {
                return scriptProgram.getFunctions().get(operation.toString()).execute(value1, value2);
            }
            throw ex;
        }
    }
