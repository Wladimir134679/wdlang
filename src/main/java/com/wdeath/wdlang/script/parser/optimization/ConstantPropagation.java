...
import com.wdeath.wdlang.script.parser.ast.ValueExpression;
...
public class ConstantPropagation extends OptimizationVisitor<Map<String, Value>> implements Optimizable {
    ...
    public ConstantPropagation(ScriptProgram scriptProgram) {
        super(scriptProgram);
    ...
    public Node optimize(Node node) {
        ...
        // Find variables
        node.accept(new VariablesGrabber(true, scriptProgram), variables);
