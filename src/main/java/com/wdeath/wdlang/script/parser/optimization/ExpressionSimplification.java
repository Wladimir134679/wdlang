...
import static com.wdeath.wdlang.script.parser.visitors.VisitorUtils.isIntegerValue;
import static com.wdeath.wdlang.script.parser.visitors.VisitorUtils.isSameVariables;
...
public class ExpressionSimplification extends OptimizationVisitor<Void> implements Optimizable {
    ...
    public ExpressionSimplification(ScriptProgram scriptProgram) {
        super(scriptProgram);
