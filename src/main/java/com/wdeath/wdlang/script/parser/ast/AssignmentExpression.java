...
public final class AssignmentExpression extends InterruptableNode implements Expression, Statement {
    ...
    public AssignmentExpression(ScriptProgram scriptProgram, BinaryExpression.Operator operation, Accessible target, Expression expr) {
    ...
    public Value eval() {
        ...
        return target.set(new BinaryExpression(scriptProgram, operation, expr1, expr2).eval());
    }
